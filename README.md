...
- **G3 stream output** - record continuous streams to so3g/spt3g `.g3` files (Observation, Wiring, Scan frames with `G3SuperTimestream` payloads) for downstream OCS / SO data pipelines.

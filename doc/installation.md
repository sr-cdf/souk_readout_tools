...
- **Clock configuration:** The PL clocks (LMK/LMX chips) are configured on boot by the `krc-utils` service. Clocks can also be reconfigured at runtime using the same service.

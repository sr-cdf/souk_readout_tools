...
server0, fpga0 = client0.get_info(['server', 'fpga'])
server1, fpga1 = client1.get_info(['server', 'fpga'])

print(server0['pipeline_id'])  # expected: 0
print(server1['pipeline_id'])  # expected: 1
```

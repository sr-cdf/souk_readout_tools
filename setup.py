...
if install_server:
    entry_points['console_scripts'].extend([
        ...
        'souk-timing-monitor-start=souk_readout_tools.server.server_scripts.souk_timing_monitor_ctl:start',
        'souk-timing-monitor-stop=souk_readout_tools.server.server_scripts.souk_timing_monitor_ctl:stop',
        'souk-timing-monitor-restart=souk_readout_tools.server.server_scripts.souk_timing_monitor_ctl:restart',
        'souk-timing-monitor-status=souk_readout_tools.server.server_scripts.souk_timing_monitor_ctl:status',
        'souk-tsu-strobe=souk_readout_tools.server.tsu_strobe:main',
        'souk-tsu-strobe-install=souk_readout_tools.server.server_scripts.souk_strobe:install',
        'souk-tsu-strobe-start=souk_readout_tools.server.server_scripts.souk_strobe:start',
        'souk-tsu-strobe-stop=souk_readout_tools.server.server_scripts.souk_strobe:stop',
        'souk-tsu-strobe-restart=souk_readout_tools.server.server_scripts.souk_strobe:restart',
        'souk-tsu-strobe-status=souk_readout_tools.server.server_scripts.souk_strobe:status',
        'souk-tsu-strobe-remove=souk_readout_tools.server.server_scripts.souk_strobe:remove',
        'souk-lna-service=souk_readout_tools.server.lna_service:main',
        'souk-lna-service-install=souk_readout_tools.server.server_scripts.souk_lna_service_ctl:install',
        'souk-lna-service-start=souk_readout_tools.server.server_scripts.souk_lna_service_ctl:start',
        'souk-lna-service-stop=souk_readout_tools.server.server_scripts.souk_lna_service_ctl:stop',
        'souk-lna-service-restart=souk_readout_tools.server.server_scripts.souk_lna_service_ctl:restart',
        'souk-lna-service-status=souk_readout_tools.server.server_scripts.souk_lna_service_ctl:status',
        'souk-lna-service-remove=souk_readout_tools.server.server_scripts.souk_lna_service_ctl:remove',
